...
**Sprint Plan:**
- Deliver employer authentication and job posting.  
- Stories: US-101, US-102, US-103, US-108.  
- Total points: 17.

**Sprint Goal:** 
Deliver the first increment of the JobListing app: employer registration/login and posting jobs.
...
**Sprint Plan:**
- Deliver job search/browse features for job seekers.  
- Stories: US-104, US-105, US-106, US-107.  
- Total points: 13.

**Sprint Goal:** 
Deliver remaining MVP features: browse jobs, search jobs, view job detail, and filter by location.
...
## Screenshots
*Github CI/CD*
![Github CI/CD](./screenshots/github-cicd.png)

*Local Testing*
![Backend Testing](./screenshots/backend-test.png)
![Frontend Testing](./screenshots/frontend-test.png)
...
![Login Error](./screenshots/signin-error.png)
...
*Job Post Success UI*
![Job Post Success](./screenshots/job-post-success.png)